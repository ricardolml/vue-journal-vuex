<template>
    ...
    <form class="login100-form validate-form p-b-33 p-t-5" @submit.prevent="onSubmit" >
        ...
        >
            <input class="input100" type="text" placeholder="Ingrese su nombre" required v-model="userForm.name" />
        ...
        >
            <input class="input100" type="email" placeholder="Ingrese su correo" required v-model="userForm.email" />
            <span class="focus-input100" data-placeholder="&#xe818;"></span>
        </div>
...
export default {
    ...
    setup(){
        ...
        const userForm = ref({
            ...
            email: 'ricardo.esp.vz@gmail.com',
            password: '123456'
        });
